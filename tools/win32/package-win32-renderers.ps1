...
$compileRoot = Join-Path $RepositoryRoot 'src\compile\win32'
$dxvkDll = Join-Path $RepositoryRoot 'src\external\3rd\dxvk\2.4\x32\d3d9.dll'
...
function Write-DxvkConfigFile {
    ...
    $profileLines = @(
        '# Auto-generated by package-win32-renderers.ps1 for DXVK packaging.',
