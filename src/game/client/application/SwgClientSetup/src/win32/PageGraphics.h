...
public:
	...
	CString m_lblUseSafeRenderer;
        CString m_graphicsRecommendationText;
        CString m_lblGraphicsPreset;
        ...
        CString m_lblPresetAuto;
        CString m_lblPresetUltra;
        CString m_lblPresetHigh;
        CString m_lblPresetBalanced;
        CString m_lblPresetPerformance;
        CString m_lblPresetCompatibility;

	CComboBox	m_vertexPixelShaderVersion;
	CComboBox	m_resolution;
	CComboBox	m_graphicsPreset;
	BOOL	m_windowed;
...
protected:
	...
	afx_msg void OnSelchangeGraphicspreset();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
private:
	...
	void refreshRecommendationText(CString const &presetLabel, bool isAutoPreset);
