...
public:
        ...
        struct GraphicsRecommendation
        {
                ...
                CString rationale;
                bool    usingModel;
                bool    disableBumpMapping;
                bool    discardHighestMipMapLevels;
                bool    discardHighestNormalMipMapLevels;
                bool    disableMultipassRendering;
                bool    disableTextureBaking;
        };

        static const TCHAR* getFileName ();

        static CString getInformationString();
        static CString getHardwareMetricsString();
        static GraphicsRecommendation getGraphicsRecommendation();
        static void applyGraphicsAutoPreset();
	...
	static void setEnableDxvk (bool enableDxvk);
	static bool getPreferDxvkForAmd ();
	static void setPreferDxvkForAmd (bool preferDxvkForAmd);
	...
	static void setAllowMissingTOC (bool allowMissingTOC);
...
private:
        ...
        static void upgradeForModernHardware();
};
