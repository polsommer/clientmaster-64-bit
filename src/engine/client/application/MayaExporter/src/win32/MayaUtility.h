...
public:
	...
	static bool getTextureReferenceExtension(const std::string &sourceTextureName, std::string &textureReferenceExtension);
	static bool buildTextureReferenceName(const std::string &sourceTextureName, const std::string &textureReferenceDirectory, std::string &textureRelativeName);
