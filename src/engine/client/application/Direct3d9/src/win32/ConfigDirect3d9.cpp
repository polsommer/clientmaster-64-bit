...
void ConfigDirect3d9::install()
{
	...
	KEY_BOOL(enableDxvk, false);
	KEY_BOOL(preferDxvkForAmd, false);
...
bool ConfigDirect3d9::getEnableDxvk()
{
...
bool ConfigDirect3d9::getPreferDxvkForAmd()
{
