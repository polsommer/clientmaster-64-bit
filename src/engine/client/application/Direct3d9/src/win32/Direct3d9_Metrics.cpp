...
namespace Direct3d9_MetricsNamespace
{
	...
	bool  ms_debugReportDrawPerPass;
        ...
        bool  ms_debugReportTessellation;
}
...
int      Direct3d9_Metrics::tessellatedDrawCalls;
int      Direct3d9_Metrics::tessellatedPatches;
char const * Direct3d9_Metrics::lastTessellationShaderName;
...
void Direct3d9_Metrics::install()
{
	...
	DebugFlags::registerFlag(ms_debugReportVertexBuffer,       "Direct3d9", "reportVertexBuffer",    debugReportVertexBuffer);
        ...
        DebugFlags::registerFlag(ms_debugReportTessellation,       "Direct3d9", "reportTessellation",    debugReportTessellation);
}
...
void Direct3d9_Metrics::remove()
{
	if (ms_installed)
	{
		...
		DebugFlags::unregisterFlag(ms_debugReportTexture);
                ...
                DebugFlags::unregisterFlag(ms_debugReportTessellation);
        }
}
...
void Direct3d9_Metrics::reset()
{
        ...
        tessellatedDrawCalls = 0;
        tessellatedPatches = 0;
        lastTessellationShaderName = 0;
...
void Direct3d9_Metrics::setLastTessellationShaderName(char const *name)
{
        lastTessellationShaderName = name;
}
...
void Direct3d9_Metrics::debugReportTessellation()
{
        if (tessellatedDrawCalls == 0)
                return;

        DEBUG_REPORT_PRINT(true, ("ts:%6d=draws   %6d=patches  %s%s\n",
                tessellatedDrawCalls,
                tessellatedPatches,
                lastTessellationShaderName ? "shader=" : "",
                lastTessellationShaderName ? lastTessellationShaderName : ""));
}
