...
public:
	...
	static int     triangles;
        ...
        static int     tessellatedDrawCalls;
        static int     tessellatedPatches;
        static char const * lastTessellationShaderName;
	...
	static int     setVertexShaderConstantsRegisters;
        ...
        static void    setLastTessellationShaderName(char const *name);
...
private:
	...
	static void  debugReportDrawPerPass();
        ...
        static void  debugReportTessellation();
};
