...
void View3dView::OnInitialUpdate() 
{
	...
	ambientLight = new Light (Light::T_ambient, VectorArgb::solidWhite);
	ambientLight->addToWorld ();

	parallelLight = new Light (Light::T_parallel, VectorArgb (CONST_REAL (1.0), CONST_REAL (1), CONST_REAL (1), CONST_REAL (1)));
