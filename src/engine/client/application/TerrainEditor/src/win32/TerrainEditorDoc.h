...
public:
        ...
        struct AutoGenerationResult
        {
                TerrainAutoPainter::Result report;
                bool                       valid;
...
private:
	...
	real                    lastMaximumChunkGenerationTime;
        ...
        bool                    m_autoShaderAssignmentEnabled;
        AutoGenerationResult    m_autoGenerationResult;
...
protected:
	...
	TerrainEditorDoc (const TerrainEditorDoc&);
        ...
        friend class TerrainAutoPainter;
...
protected:
	...
	afx_msg void OnNewAffectorEnvironment();
        ...
        afx_msg void OnAiAutogenerate();
        afx_msg void OnUpdateAiAutogenerate(CCmdUI* pCmdUI);
        afx_msg void OnAiRunAudit();
        afx_msg void OnUpdateAiRunAudit(CCmdUI* pCmdUI);
        //}}AFX_MSG
        DECLARE_MESSAGE_MAP()
...
public:
	...
	ConsoleFrame*           getConsoleFrame (void);
        ...
        void                    setGuidedCreationFrame (GuidedCreationFrame* frame);
        GuidedCreationFrame*    getGuidedCreationFrame () const;
	...
	real                    getLastTotalChunkGenerationTime (void) const;
        ...
        bool                    isAutoShaderAssignmentEnabled() const;
        ...
        void                    setAutoShaderAssignmentEnabled(bool enabled);

        void                    setAutoGenerationResult(const AutoGenerationResult &result);
        const AutoGenerationResult &getAutoGenerationResult() const;
        bool                    hasAutoGenerationResult() const;
...
inline void TerrainEditorDoc::setGuidedCreationFrame (GuidedCreationFrame* frame)
{
        guidedCreationFrame = frame;
}

//-------------------------------------------------------------------

inline GuidedCreationFrame* TerrainEditorDoc::getGuidedCreationFrame () const
{
...
{
        return m_environmentCycleTime / 60;
}
