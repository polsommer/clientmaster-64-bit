...
bool CreatureObject::isAppearanceWearable(Object const &object, std::string *appearancePath, bool * const prohibitAttachmentVisuals ) const
{
	...
	else
	{
		...
		switch (species)
		{
			...
			case SharedCreatureObjectTemplate::SP_aqualish:   { column = 21; } break;
			case SharedCreatureObjectTemplate::SP_nightsister:   { column = 23; } break;
			case SharedCreatureObjectTemplate::SP_togruta:   { column = 25; } break;
			case SharedCreatureObjectTemplate::SP_bith:   { column = 27; } break;
			case SharedCreatureObjectTemplate::SP_nikto:   { column = 29; } break;
			case SharedCreatureObjectTemplate::SP_marauder:   { column = 31; } break;
			case SharedCreatureObjectTemplate::SP_klaatu:   { column = 33; } break;
			case SharedCreatureObjectTemplate::SP_chiss:   { column = 35; } break;
			case SharedCreatureObjectTemplate::SP_ishitib:   { column = 37; } break;
			case SharedCreatureObjectTemplate::SP_nautolan:   { column = 39; } break;
			case SharedCreatureObjectTemplate::SP_weequay:   { column = 41; } break;
			case SharedCreatureObjectTemplate::SP_arcona:   { column = 43; } break;
			case SharedCreatureObjectTemplate::SP_devaronian:   { column = 45; } break;
