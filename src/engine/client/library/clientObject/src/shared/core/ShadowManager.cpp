...
namespace ShadowManagerNamespace
{
	...
	const float cms_maximumVolumetricShadowDistance = 2048.f; // Increased for max quality
	const float cms_minimumSimpleShadowDistance = 32.f;
	const float cms_maximumSimpleShadowDistance = 1024.f; // Increased for wider coverage
	const float cms_ignoreRatio = 0.f;     // Zero to never ignore shadows
	const float cms_fogNaturalBase = 2.71828f;
	const float cms_fogCutOff = 1.0f;     // High to avoid early cutoffs


	// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

	bool  ms_enabled = true;                                // Enable shadowing
	bool  ms_allowed = true;
	bool  ms_debugReport = true;                                // Enable debugging info
	float ms_maximumVolumetricShadowDistance = cms_maximumVolumetricShadowDistance;
	float ms_volumetricShadowDistanceLevel = 1.0f;                         // Full detail level
	float ms_shadowDetailLevel = 1.0f;                                 // Max shadow resolution/detail
	float ms_volumetricShadowDistance = cms_maximumVolumetricShadowDistance; // Max volumetric range
	bool  ms_meshShadows = true;                                // Enable mesh shadows
	float ms_simpleShadowDistance = cms_maximumSimpleShadowDistance;     // Max simple shadow range
	int   ms_skeletalShadows = SST_volumetric;                      // Highest quality skeletal shadows
	float ms_timeOfDay = 12.0f;                                // Midday for consistency
