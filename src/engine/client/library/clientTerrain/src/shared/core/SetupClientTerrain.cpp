...
void SetupClientTerrain::install()
{
	...
	if (ConfigClientTerrain::getUseHighQualityTerrainProfile())
	{
		DEBUG_REPORT_LOG_PRINT(ConfigSharedTerrain::getDebugReportInstall(), ("ClientTerrain high quality profile enabled\n"));
	}
