...
public:
	...
	static bool  getDynamicNearFloraEnabled         ();
        ...
        static bool  getUseHighQualityTerrainProfile ();

        static float getInteriorLightBoost ();
        static float getInteriorAmbientDampen ();
        static float getInteriorFogDensityScale ();
