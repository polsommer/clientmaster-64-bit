...
void TextureList::assignAsynchronousLoaderFunctions()
{
	if (AsynchronousLoader::isInstalled())
	{
		...
		AsynchronousLoader::bindFetchReleaseFunctions("png", &asynchronousLoaderFetchNoCreate, &asynchronousLoaderRelease);
		AsynchronousLoader::bindFetchReleaseFunctions("pgn", &asynchronousLoaderFetchNoCreate, &asynchronousLoaderRelease);
	}
}
