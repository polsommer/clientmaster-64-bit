...
static bool           getEnableHighQualityTessellation();
static bool           getEnableHighQualityPreset();
        static bool           getHighQualityEnableAntialiasing();
        static bool           getHighQualityEnableCinematicEffects();
        static bool           getEnableSsao();
        static int            getSsaoQuality();
        static float          getSsaoRadius();
        static int            getHighQualityMinimumVideoMemoryMB();
        static int            getHighQualityMinimumSystemMemoryMB();
        static int            getHighQualityMinimumShaderCapabilityMajor();
static int            getHighQualityMinimumShaderCapabilityMinor();
static float          getHighQualityCinematicStrength();
