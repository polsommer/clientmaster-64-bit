...
#if CUI_SUPPORTS_SCREEN_SPACE_REFLECTIONS
#include "clientGame/ScreenSpaceReflections.h"
#endif
#if CUI_SUPPORTS_VOLUMETRIC_LIGHTING
...
#if CUI_SUPPORTS_SCREEN_SPACE_REFLECTIONS
	ScreenSpaceReflections::preSceneRender();
#endif
#if CUI_SUPPORTS_VOLUMETRIC_LIGHTING
        VolumetricLighting::preSceneRender();
#endif
...
#if CUI_SUPPORTS_SCREEN_SPACE_REFLECTIONS
	ScreenSpaceReflections::postSceneRender();
#endif
#if CUI_SUPPORTS_VOLUMETRIC_LIGHTING
        VolumetricLighting::postSceneRender();
#endif
