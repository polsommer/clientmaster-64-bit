...
// Suppress noisy standard library warnings emitted by VS2013/STLport
// headers to keep UIBuilder builds clean.
#pragma warning (disable:4996) // MBCS deprecation noise
#pragma warning (disable:4183) // implicit int return type in legacy headers
#pragma warning (disable:4103) // alignment change after including header
#pragma warning (disable:4159) // #pragma pack(pop) identifier mismatch
