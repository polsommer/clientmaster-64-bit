...
public:
   ...
   void cancelDrag();
	...
	// User edits.
        ...
        bool          upscaleSelectionsSmart();
        bool          upscaleSelectionsAuto();
        bool          autoLayoutSelectionsResponsive(int preferredColumns = 0, bool allowResize = false);
        bool          centerSelectionInParent();
...
protected:
	...
	bool _edit_upscaleSelections(bool centerExpansion);
	bool _computeHdRecommendation(long &outWidth, long &outHeight) const;
