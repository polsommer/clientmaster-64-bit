...
public:
	...
	{}
        ...
        virtual bool canCopyName() const { return true; }
        virtual bool canCopyValue() const { return true; }
        virtual bool canCopyIdentifier() const { return false; }
        virtual CString getNameForCopy() const;
        virtual CString getValueForCopy() const;
        virtual CString getDisplayName() const;
        virtual CString getIdentifierForCopy() const { return CString(); }
...
protected:
	...
	// --------------------------------------------------------
        ...
        void copyToClipboard(const CString &text) const;
...
protected:
	...
	afx_msg void OnRclick(NMHDR* pNMHDR, LRESULT* pResult);
        ...
        afx_msg void OnCopyPropertyIdentifier();
