...
# define _STLP_INTERLOCKED_IMPORT
#else
# define _STLP_INTERLOCKED_IMPORT _STLP_IMPORT_DECLSPEC
#endif

#if (_MSC_VER >= 1300) || defined (_STLP_NEW_PLATFORM_SDK)
_STLP_INTERLOCKED_IMPORT long _STLP_STDCALL InterlockedIncrement(long volatile *);
_STLP_INTERLOCKED_IMPORT long _STLP_STDCALL InterlockedDecrement(long volatile *);
_STLP_INTERLOCKED_IMPORT long _STLP_STDCALL InterlockedExchange(long volatile *, long);
#else
...
_STLP_INTERLOCKED_IMPORT long _STLP_STDCALL InterlockedIncrement(long*);
_STLP_INTERLOCKED_IMPORT long _STLP_STDCALL InterlockedDecrement(long*);
_STLP_INTERLOCKED_IMPORT long _STLP_STDCALL InterlockedExchange(long*, long);
#endif

#undef _STLP_INTERLOCKED_IMPORT
