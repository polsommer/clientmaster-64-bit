...
#define DPVS_SNPRINTF _snprintf
#else
#define DPVS_SNPRINTF std::snprintf
#endif
...
const char* Library::getInfoString (InfoString t)
{
	...
	switch (t)
	{
                case VERSION:
                {
                        ...
                        DPVS_SNPRINTF(s_tmp, sizeof(s_tmp), "dPVS %d.%d.%d", DPVS_VERSION_MAJOR, DPVS_VERSION_MINOR, DPVS_VERSION_REVIS);
                        return s_tmp;
                }
